...
class PropExpertsRatingController extends Controller
{
    ...
    {
        $grid = new Grid(new PropExpertsRating);
    ...
    {
        $show = new Show(PropExpertsRating::findOrFail($id));
    ...
    {
        $form = new Form(new PropExpertsRating);
