...
casper.then(function() {
    casper.wait(5000, function() {
        ...
        var html = this.evaluate(function(){
            return document.querySelector(".center-content.content-catalog").outerHTML; // ".items-container"
        });
        // Save HTML
        // fs = require('fs');
        // fs.write('/home/murin/_dev/_Denis/vinobaza/vinobaza-front/html3.txt', html, 'w');
